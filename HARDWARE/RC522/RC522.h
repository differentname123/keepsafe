...
/***********************RC522 函数宏定义**********************/
#define          RC522_CS_Enable()         HAL_GPIO_WritePin(GPIOD,GPIO_PIN_5,GPIO_PIN_RESET)
#define          RC522_CS_Disable()        HAL_GPIO_WritePin(GPIOD,GPIO_PIN_5,GPIO_PIN_SET)

#define          RC522_Reset_Enable()      HAL_GPIO_WritePin(GPIOD,GPIO_PIN_3,GPIO_PIN_RESET)
#define          RC522_Reset_Disable()     HAL_GPIO_WritePin(GPIOD,GPIO_PIN_3,GPIO_PIN_SET)
